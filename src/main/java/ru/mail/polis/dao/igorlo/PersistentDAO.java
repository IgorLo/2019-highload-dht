...
public class PersistentDAO implements DAO {
    ...
    @NotNull private MemoryTablePool memTablePool;
     ...
     */
    public PersistentDAO(final long maxHeap, @NotNull final File rootDir, final int threadsToFlush) throws IOException {
        ...
        this.memTablePool = new MemoryTablePool(
                maxHeap,
                indexSStable.get(),
                threadsToFlush,
                new FlushingTask());
    ...
    @NotNull
    private Iterator<TableRow> rowsIterator(@NotNull final ByteBuffer from) throws IOException {
